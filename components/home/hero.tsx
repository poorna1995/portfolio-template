		...
		<div className="grid grid-cols-12">
			...
			<div className="col-span-8 p-24">
				...
				<p className="mt-4 text-lg font-normal">
					...
					, I also go by “the most Inquisitive learner and Passionate
					in the room”
				</p>
				<p className="my-4 text-lg font-normal">
					...
					and a creative thinker with 6+ years of industry experience
					in team building & leadership. Strongly driven towards
					creating value for business & technology stakeholders.
				</p>
